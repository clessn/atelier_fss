...
![](https://www.clessn.com/assets/img/logo-black.svg){.absolute top=330 left=630 width="30%"}
![](_SharedFolder_fss_introduction_r/img/yaduf.png){.absolute top=530 left=0 width="35%"}
Chaire de leadership en enseignement des sciences sociales numériques (CLESSN)
...
![](_SharedFolder_fss_introduction_r/img/ex/cluster1.png){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}

##

![](_SharedFolder_fss_introduction_r/img/ex/cluster2.png){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}
...
##
![](_SharedFolder_fss_introduction_r/img/ex/clustering_results2.png){.absolute left=0 right=0 bottom=0 top=0 height="90%" style="margin: auto auto;"}
...
:::{.column width="50%"}
![](https://9infotech.weebly.com/uploads/1/7/5/2/17521169/sample-file-path_orig.png){.absolute top=240 left=600 width="50%"}
