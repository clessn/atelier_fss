...
## Enregistrer le csv
#saveRDS(data, paste0("../Data/", "dataset_refugees.rds"))
...
## Enregistrer le csv
#write_csv(dataSyrie2015, paste0("../Data/", "dataset_refugees-Syria.csv"))
...
#write_csv(dataUkraine, paste0("../Data/", "dataset_refugees-Ukraine.csv"))
...
ggsave("graphs/nbArticles/nbArticles-syrie-ukraine.png", plot, width = 30, height = 17, units = c("cm"))
...
#
# ggsave("graphs/_v2/lexicoder/lexicoder-ukraine.png", width = 30, height = 17, units = c("cm"))
...
ggsave("graphs/_v2/timeSeries/time-series.png", width = 30, height = 17, units = c("cm"))
...
ggsave("graphs/_v2/nrc/nrc-syrie-ukraine.png", plot, width = 30, height = 17, units = c("cm"))
...
ggsave("graphs/_v2/lda_syrie_2015/3k_LDAbeta-syrie2015.png", width = 30, height = 17, units = c("cm"))
...
ggsave("graphs/_v2/lda_syrie_2015/3k_LDAgamma-syrie2015.png", width = 30, height = 17, units = c("cm"))
