...
#path_to_folder <- "../Data/raw_syrie/UK-The Sun-Syrie"
...
clean_star_rtf <- function(path_to_folder, file_name, country) {
  ...
  # Décommenter ces lignes juste pour tester l'intérieur de la fonction
 #  path_to_folder <- "../Data/raw_syrie/CA-Toronto Star-Syrie"
...
clean_globe_rtf <- function(path_to_folder, file_name, country) {
  ...
  # Décommenter ces lignes juste pour tester l'intérieur de la fonction
  # path_to_folder <- "../Data/raw_syrie/CA-Globe&Mail-Syrie"
...
clean_gardian_rtf <- function(path_to_folder, file_name, country) {
  ...
  # Décommenter ces lignes juste pour tester l'intérieur de la fonction
  # path_to_folder <- "../Data/raw_syrie/UK-Guardian-Syrie"
...
clean_nyt_rtf <- function(path_to_folder, file_name, country) {
  ...
  # Décommenter ces lignes juste pour tester l'intérieur de la fonction
 path_to_folder <- "../Data/raw_syrie/US-NYTimes-Syrie"
...
clean_timesUK_rtf <- function(path_to_folder, file_name, country) {
  ...
  # Décommenter ces lignes juste pour tester l'intérieur de la fonction
  #  path_to_folder <- "../Data/raw_ukraine/UK-The Times-Ukraine"
...
clean_WPost_rtf <- function(path_to_folder, file_name, country) {
  ...
  # Décommenter ces lignes juste pour tester l'intérieur de la fonction
  #  path_to_folder <- "../Data/raw_ukraine/US-WaPo-Ukraine"
  # file_name <- "US-WaPo-Ukraine-1.rtf"
  # country = "Ukraine"
...
# # The Sun - Syrie ####
# file_names <- list.files("../Data/raw_syrie/UK-The Sun-Syrie")
# for (file_name in file_names) {
#   dfi <- clean_sun_rtf(path_to_folder = "../Data/raw_syrie/UK-The Sun-Syrie",
#                        file_name =  file_name,
#                        country =  "Syrie")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
# }
#
# # The Sun - Ukraine ####
# file_names <- list.files("../Data/new_ukraine/UK-The-Sun")
# for (file_name in file_names) {
#   dfi <- clean_sun_rtf(path_to_folder = "../Data/new_ukraine/UK-The-Sun",
#                        file_name = file_name,
#                        country = "Ukraine")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
#
# # Globe - Syrie ####
# file_names <- list.files("../Data/raw_syrie/CA-Globe&Mail-Syrie")
# for (file_name in file_names) {
#   dfi <- clean_globe_rtf(path_to_folder = "../Data/raw_syrie/CA-Globe&Mail-Syrie",
#                         file_name = file_name,
#                         country = "Syrie")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
# # Globe - Ukraine ####
# file_names <- list.files("../Data/new_ukraine/CA-Globe-and-Mail")
# for (file_name in file_names) {
#   dfi <- clean_globe_rtf(path_to_folder = "../Data/new_ukraine/CA-Globe-and-Mail",
#                          file_name = file_name,
#                          country = "Ukraine")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
#
# # Gardian - Syrie ####
# file_names <- list.files("../Data/raw_syrie/UK-Guardian-Syrie")
# for (file_name in file_names) {
#   dfi <- clean_gardian_rtf(path_to_folder = "../Data/raw_syrie/UK-Guardian-Syrie",
#                          file_name = file_name,
#                          country = "Syrie")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
# # Gardian - Ukraine ####
# file_names <- list.files("../Data/new_ukraine/UK-Guardian")
# for (file_name in file_names) {
#   dfi <- clean_gardian_rtf(path_to_folder = "../Data/new_ukraine/UK-Guardian",
#                          file_name = file_name,
#                          country = "Ukraine")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
#
# # Star - Syrie ####
# file_names <- list.files("../Data/raw_syrie/CA-Toronto Star-Syrie")
# for (file_name in file_names) {
#   dfi <- clean_star_rtf(path_to_folder = "../Data/raw_syrie/CA-Toronto Star-Syrie",
#                          file_name = file_name,
#                          country = "Syrie")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
# # Star - Ukraine ####
# file_names <- list.files("../Data/new_ukraine/CA-Toronto-Star")
# for (file_name in file_names) {
#   dfi <- clean_star_rtf(path_to_folder = "../Data/new_ukraine/CA-Toronto-Star",
#                          file_name = file_name,
#                          country = "Ukraine")
#   saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
#   print(file_name)
...
# NYT - Syrie ####
file_names <- list.files("../Data/raw_syrie/US-NYTimes-Syrie")
#for (file_name in file_names[12:18]) {
for (file_name in file_names) {
  dfi <- clean_nyt_rtf(path_to_folder = "../Data/raw_syrie/US-NYTimes-Syrie",
                        file_name = file_name,
                        country = "Syrie")
  saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
  print(file_name)
...
# NYT - Ukraine ####
file_names <- list.files("../Data/new_ukraine/US-New-York-Times")
for (file_name in file_names) {
  dfi <- clean_nyt_rtf(path_to_folder = "../Data/new_ukraine/US-New-York-Times",
                         file_name = file_name,
                         country = "Ukraine")
  saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
  print(file_name)
...
# Times UK - Syrie ####
file_names <- list.files("../Data/raw_syrie/UK-The Times-Syrie")
for (file_name in file_names) {
  dfi <- clean_timesUK_rtf(path_to_folder = "../Data/raw_syrie/UK-The Times-Syrie",
                       file_name = file_name,
                       country = "Syrie")
  saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
  print(file_name)
...
# Times UK - Ukraine ####
file_names <- list.files("../Data/new_ukraine/UK-The-Times")
for (file_name in file_names) {
  dfi <- clean_timesUK_rtf(path_to_folder = "../Data/new_ukraine/UK-The-Times",
                       file_name = file_name,
                       country = "Ukraine")
  saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
  print(file_name)
...
# WPost - Syrie ####
file_names <- list.files("../Data/raw_syrie/US-WaPo-Syrie")
for (file_name in file_names) {
  dfi <- clean_WPost_rtf(path_to_folder = "../Data/raw_syrie/US-WaPo-Syrie",
                           file_name = file_name,
                           country = "Syrie")
  saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
  print(file_name)
...
# WPost - Ukraine ####
file_names <- list.files("../Data/new_ukraine/US-Washington-Post")
for (file_name in file_names) {
  dfi <- clean_WPost_rtf(path_to_folder = "../Data/new_ukraine/US-Washington-Post",
                           file_name = file_name,
                           country = "Ukraine")
  saveRDS(dfi, paste0("../Data/clean/", file_name, ".rds"))
  print(file_name)
...
# rds_all <- list.files( path = "../Data/clean", pattern = "*.rds", full.names = TRUE) %>%
#  map_dfr(readRDS) %>%
...
#                                                                    ifelse(source == "The Times", "UK", "Error!!"))))))))

## Enregistrer le csv
#saveRDS(rds_all, paste0("../Data/", "dataset.rds"))
