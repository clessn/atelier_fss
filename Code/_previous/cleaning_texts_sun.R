...
data <- read_rtf("../Data/raw_ukraine/UK-TheSun-Ukraine/Uk-TheSun-Ukraine-3.rtf") #16h56
name <- "Uk-TheSun-Ukraine-3.rtf"
...
df_data2 <- df_data %>%
  mutate(variable =
           ...
           ifelse(grepl("Document [A-Z]+", data), "doc_id", "text"))))),
         id =
...
########################################################################################################### ##
 ...
 test <- readRDS("/Users/adrien/Dropbox/Travail/Universite_Laval/CLESSN/_SharedFolder_article_syrie-ukraine/2022-UkraineSyriaProject/Data/clean/dataset.rds")
#
