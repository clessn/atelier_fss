---
title: "Graphique en barres de l'indice de tonalité par pays"
format: html
editor: source
---
...
Ce document génère un graphique en barres pour représenter l'indice de tonalité par pays.
...
```{r}
data <- readRDS("../data/exercice1/data_analyse_textuelle.rds")
```
...
```{r}
ggsave("graphs/tone_by_country.png", width = 8, height = 6, units = "in")
```
