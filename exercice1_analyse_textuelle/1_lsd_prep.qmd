...
```{r}
data <- readRDS("../data/initial_data.rds")
```
...
## Mesure de la durée de préparation

Nous enregistrons le temps de début et de fin de la préparation pour calculer la durée totale de l'opération.
